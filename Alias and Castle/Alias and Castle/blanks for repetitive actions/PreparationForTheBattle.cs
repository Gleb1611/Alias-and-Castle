...
namespace Alias_and_Castle
{
    ...
    {
        public static void Fight(ref List<MedKit> medKit, ref int healsEnemy, Random random, ref int heals,
            ref string weapon, ref int damageArm, ref int damage, ref int damageEneme, ref string nameCharacter,
            ref int littleHealsInInventory, ref int items, ref int littleHealsPosion, ref string enemy,
            ref int CreedDamegeEnemy, ref int maxHeals)
        {
            Console.Clear();
