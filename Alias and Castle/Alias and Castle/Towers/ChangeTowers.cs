                        ...
                        if (towerTimerThree == 0)
                        {
                            ...
                            switch (decision)
                            {
                                case "1":
                                    ...
                                    towerTimerThree = 1;
                                    Third.TowerThree(nameCharacter, decision, ref littleHealsInInventory, ref heals, ref weapon, ref damageArm, ref damage, ref items, ref littleHealsPosion, ref maxHeals);
                                    break;
