...
namespace Alias_and_Castle.Towers
{
    internal class Third
    {
        public static void TowerThree(string nameCharacter, string decision, ref int littleHealsInInventory, ref int heals, ref string weapon, ref int damageArm, ref int damage, ref int items, ref int littleHealsPosion, ref int maxHeals)
        {
            ...
            PreparationForTheBattle.Fight(ref healsEnemy, random, ref heals, ref weapon, ref damageArm, ref damage, ref damageEneme, ref nameCharacter, ref littleHealsInInventory, ref items, ref littleHealsPosion, ref enemy, ref CreedDamegeEnemy, ref maxHeals);
